...
Commits to empowering startups to succeed by transforming ideas into reliable, user-centric products. Bridges the gap between technology and business strategy, ensuring that every solution not only works technically but also delivers measurable value.

Focuses on exploring the intersection of decentralized and traditional finance, combining crypto and fiat systems to redefine how people experience and interact with money.

Believes in the transformative potential of AI, using Narrow AI today to improve existing solutions, optimize processes and create practical value. Envisions Strong AI as the future driver of smarter, more efficient products and entirely new ways to deliver value, opening opportunities that are currently impossible.
